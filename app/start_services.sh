...
NAMES=("server" "recorder" "cleanup" "uploader" "youtube_restart")
CMDS=("python server.py" "python recorder.py" "python cleanup.py" "python youtube_uploader/main.py" "python youtube_restart.py")
PIDS=()
